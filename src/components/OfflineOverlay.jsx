    ...
    <AnimatePresence>
      {visible ? (
        <motion.div
          ...
          className="pointer-events-auto fixed inset-0 z-[10050] flex flex-col items-center justify-center gap-5 bg-white/10 px-[min(8vw,2rem)] text-center backdrop-blur-md"
        >
          <motion.div
            ...
            className="flex w-full max-w-[min(90vw,24rem)] flex-col items-center gap-4"
          >
            <h2
